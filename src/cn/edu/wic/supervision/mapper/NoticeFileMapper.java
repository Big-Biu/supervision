...
{
	@Select("insert into notice_file"
			+ "(filename, size, file, notice)"
	...
	public List<NoticeFile> find(@Param("notice")Integer notice, @Param("table")Table table);
	
	@SelectProvider(type=NoticeFileMapperProvider.class, method="findFilesByIds")
	public List<NoticeFile> findFilesByIds(@Param("notice")Integer notice, @Param("ids")Integer[] ids);
}
