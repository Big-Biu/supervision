...
public interface NoticeMapper
{
	...
	@Select("select id,title,content,time,type,state,author"
			+ " from notice"
			+ " where id=#{id}")
	...
	public List<Notice> find(@Param("page")Integer page, @Param("rows")Integer rows);
